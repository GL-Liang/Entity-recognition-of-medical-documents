...
flags.DEFINE_string("train_file",   os.path.join("data", "split", "1", "example.train"),  "Path for train data")
flags.DEFINE_string("dev_file",     os.path.join("data", "split", "1", "example.dev"),    "Path for dev data")
flags.DEFINE_string("test_file",    os.path.join("data", "split", "1", "example.test"),   "Path for test data")
